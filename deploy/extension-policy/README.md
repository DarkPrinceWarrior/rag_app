...
6. Обновить уже открытые веб-страницы через `Ctrl+R`, чтобы Chrome подключил к
   ним content script установленной версии.
...
расширения на `chrome://extensions`, затем обновляет открытые вкладки.
